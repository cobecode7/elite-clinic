...
const seedDatabase = async () => {
  try {
    ...
    await Booking.bulkCreate([
      { name: 'محمد العلي', phone: '0555555555', department: 'derma', doctorId: doctors[0].id, status: 'pending' },
      { name: 'فاطمة أحمد', phone: '0566666666', department: 'heart', doctorId: doctors[1].id, status: 'confirmed' },
      { name: 'عبدالله سعد', phone: '0577777777', department: 'kids', doctorId: doctors[2].id, status: 'pending' },
      { name: 'مها خالد', phone: '0588888888', department: 'dentist', doctorId: doctors[3].id, status: 'pending' },
      { name: 'زائر غير محدد الطبيب', phone: '0599999999', department: 'derma', doctorId: null, status: 'pending' }
    ]);
